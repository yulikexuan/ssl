...
import com.yulikexuan.ssl.domain.services.SslActiveUserService;
...
public class UserController {
    ...
    private final SslActiveUserService activeUserService;

    @Autowired
    public UserController(IUserService userService,
                          PasswordEncoder passwordEncoder,
                          SslActiveUserService activeUserService) {
    ...
    public ModelAndView list() {
        ...
        Iterable<UserDto> users = this.activeUserService.getAllActiveUsers()
                .stream()
                .map(n -> UserDto.builder().username(n).build())
