...
//@EnableAsync
//@EnableWebSecurity
public class SslBasicSecurityConfigerAdapterWithComments extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SslBasicSecurityConfigerAdapterWithComments(UserDetailsService userDetailsService) {
