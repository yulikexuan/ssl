...
import com.yulikexuan.ssl.domain.services.*;
...
public class RegistrationController {
    ...
    public ModelAndView getRegistrationForm() {
        ...
        final Map<String, Object> model = ImmutableMap.of(
                "user", new UserDto(),
                "questions", this.secuQuestionDefService.findAll());
    ...
    public ModelAndView registerUser(@Valid final UserDto user,
        ...
        try {
            ...
            User saveUser = this.userService.saveUser(
                    userMapper.userDtoToUser(user), questionId, answer);
    ...
    public ModelAndView showChangePasswordPage(
        ...
        ModelAndView modelAndView =
                ...
                .map(user -> {
                    ...
                    Long securityQuestionId = this.userService
                            .getSecurityQuestionDefinitionIdByUser(user);

                    ImmutableMap<String, Object> model =
                            ImmutableMap.of("questions", this.secuQuestionDefService.findAll(),
                                    "selectedId", securityQuestionId);

                    return new ModelAndView("resetPasswordFormPage", model);
                })
                .orElseGet(() -> {
                    redirectAttributes.addFlashAttribute(
                            "errorMessage",
    ...
    public ModelAndView saveNewPassword(
            ...
            @RequestParam("passwordConfirmation")
        ...
        if (!this.userService.isSecurityQuestionAnswerCorrect(user, answer)) {
            Map<String, Object> model = ImmutableMap.of(
                    "errorMessage", "Answer to security question is incorrect",
                    "questions", this.secuQuestionDefService.findAll());
            return new ModelAndView(
                    "resetPasswordFormPage", model);
        }
